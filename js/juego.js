...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo("imagenes/valla_vertical.png", 528, 400, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 380, 80, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 325, 150, 30, 15, 1),
    new Obstaculo("imagenes/bache.png", 300, 480, 15, 30, 1),
    new Obstaculo("imagenes/bache.png", 400, 200, 30, 30, 1),
    new Obstaculo("imagenes/auto_verde_abajo.png", 160, 150, 15, 30, 1),
    new Obstaculo("imagenes/auto_verde_derecha.png", 160, 300, 30, 15, 1),
    new Obstaculo("imagenes/valla_vertical.png", 750, 200, 30, 30, 1),
    new Obstaculo("imagenes/valla_vertical.png", 780, 470, 30, 30, 1)
  ...
  enemigos: [
    new ZombieCaminante("imagenes/zombie1.png", 100, 100, 10, 10, 1, { desdeX: 10, hastaX: 870, desdeY: 0, hastaY: 976 }),
    new ZombieCaminante("imagenes/zombie2.png", 200, 150, 10, 10, 1, { desdeX: 0, hastaX: 870, desdeY: 0, hastaY: 961 }),
    new ZombieCaminante("imagenes/zombie3.png", 300, 180, 10, 10, 1, { desdeX: 0, hastaX: 870, desdeY: 0, hastaY: 950 }),
    new ZombieCaminante("imagenes/zombie4.png", 400, 190, 10, 10, 1, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 950 }),
    new ZombieCaminante("imagenes/zombie3.png", 500, 300, 10, 10, 1, { desdeX: 0, hastaX: 950, desdeY: 0, hastaY: 800 }),
...
Juego.capturarMovimiento = function (tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    de sus metodos  */
    this.jugador.desplazarse(movX, movY);
  }
};
...
Juego.dibujarFondo = function () {
  ...
  // Si se gano el juego hay que mostrar el mensaje de ganoJuego de fondo
    ...
    Dibujante.dibujarRectangulo("yellow", 760, 510, 126, 126);
  }
};
